...
<div id="page" class="container-fluid" style="margin-top: 66px">
    <div id="page-content">
        <div role="main"><span id="user-notifications"></span><span id="maincontent"></span>
            <div style="text-align: center" data-region="grading-navigation-panel" data-first-userid="48"
                 data-courseid="66"
                ...
                <div class="">
                    <div data-region="grading-navigation" class="row">
                        ...
                        <div data-region="user-info" class="col-md-4" data-assignmentid="118" data-groupid="0" style="">
                            <h4 id="yui_3_17_2_1_1524980899832_397">
                                <a href="#">
                                    <img src="{{ asset('images/review-icon.png') }}"
                                         class="img-rounded" height="40" role="presentation">{{__("Review Form")}}
                                </a>
                            </h4>
                        </div>
            ...
            <div data-region="grade-panel" class="fullwidth">
                <div data-region="grade" data-contextid="1324" data-assignmentid="118"
                    ...
                    <div class="submissionstatustable" id="yui_3_17_2_1_1524980899832_375">
                        <h3>{{__('Submission of '.$student_name)}}</h3>
                        ...
                        <div class="assignsubmission assignsubmission_onlinetext">
                            <div class="box boxaligncenter plugincontentsummary summary_assignsubmission_onlinetext_90 p-y-1">
                                ...
                                <div class="no-overflow">
                                    <p>{{__('Submission Title')}}: {{$submission->title}}</p>
                            ...
                            <div class="box boxaligncenter plugincontentsummary summary_assignsubmission_comments_90 p-y-1">
                                <div class="commentscontainer">
                                    ...
                                    <div class="mdl-left">
                                        ...
                                        <a class="comment-link" id="comment-link-5ae55caeee706" href="#"
                                           role="button" aria-expanded="false">
                                            <i class="icon fa fa-plus-square fa-fw " aria-hidden="true"
                                                    title="Comments" aria-label="Comments"></i>
                                            <span id="comment-link-text-5ae55caeee706">Comments (0)</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <fieldset class="clearfix" id="id_gradeheader">
                                ...
                                <div class="fcontainer clearfix" id="yui_3_17_2_1_1524980899832_364">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="general_comment" name="general_comment"
                                    ...
                                    <div class="form-group row  fitem   ">
                                        ...
                                        <div class="col-md-9 form-inline felement" data-fieldtype="text">
                                            <input id="mark" name="mark" class="col-form-label col-md-2" type="number"
                                                   step="0.1"
                                                   value="10.0">
                                        </div>
                                    </div>

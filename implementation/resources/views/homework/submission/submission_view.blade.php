                        ...
                        <div class="breadcrumb-nav">
                            <nav role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                                href=""
                                                title="Digital Literacy ">{{__($course_name)}}</a></li>
                                    <li class="breadcrumb-item"><a
                                                href="#"
        ...
        <div id="region-main-box" class="col-xs-12">
            <section id="region-main">
                <div class="card card-block" id="yui_3_17_2_1_1524923385116_63">
                    ...
                    <div role="main" id="yui_3_17_2_1_1524923385116_62"><span id="maincontent"></span>
                        <h2>Assignment {{__($homework->homework_no)}} (Text)</h2>
                        <div id="intro" class="box generalbox boxaligncenter p-y-1">
                            <div class="no-overflow"><p>{{__($homework->title)}}</p>
                                <p>{{__($homework->content)}}</p></div>
                        </div>
                        <div class="submissionstatustable" id="yui_3_17_2_1_1524923385116_61"><h3>Submission status</h3>
                                                ...
                                                <div class="commentscontainer">
                                                    ...
                                                    <div class="mdl-left">
                                                        <a class="showcommentsnonjs"
                                                                             href="">Show
                                                            comments</a><a class="comment-link"
                                                                           id="comment-link-5ae47bfd41fac" href="#"
                                                                           role="button" aria-expanded="false"><i
                                                                    class="icon fa fa-plus-square fa-fw "
                                                                    aria-hidden="true" title="Comments"
                                                                    aria-label="Comments"></i><span
                                                                    id="comment-link-text-5ae47bfd41fac">Comments (0)</span></a>
                                                        <div id="comment-ctrl-5ae47bfd41fac" class="comment-ctrl">
                                                            ...
                                                            <div class="comment-area">
                                                                <div class="db"><textarea name="content" rows="2"
                                                                                          ...
                                                                                          cols="20"
                                                                                          style="color: grey;"></textarea>
                                                                </div>
                                                                <div class="fd" id="comment-action-5ae47bfd41fac"><a
                                                                            id="comment-action-post-5ae47bfd41fac"
                                                                            href="#">Save comment</a><span> | </span><a
                                                                            id="comment-action-cancel-5ae47bfd41fac"
                                                                            href="#">Cancel</a></div>
                                                            </div>
                            ...
                            <div class="box generalbox submissionaction p-y-1" id="yui_3_17_2_1_1524923385116_60">
                                ...
                                <div class="box boxaligncenter submithelp p-y-1" id="yui_3_17_2_1_1524923385116_59">Make
